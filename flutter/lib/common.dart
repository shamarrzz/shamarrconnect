...
class MyTheme {
  ...
  // Brand palette: logo gradient #5B7BF0 → #1E3FA8
  static const Color accent = Color(0xFF4A6CF7);
  static const Color accent50 = Color(0x774A6CF7);
  static const Color accent80 = Color(0xAA4A6CF7);
  ...
  static const Color button = Color(0xFF5B7BF0);
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://shamarrconnect.com'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
