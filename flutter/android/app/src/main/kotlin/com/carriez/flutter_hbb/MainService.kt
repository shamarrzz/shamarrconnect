...
const val DEFAULT_NOTIFY_TITLE = "ShamarrConnect"
...
class MainService : Service() {
    ...
    private fun initNotification() {
        ...
        notificationChannel = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            // Channel id change creates a new channel; the old "RustDesk" channel
            // may linger in system settings until the app is reinstalled.
            val channelId = "ShamarrConnect"
            val channelName = "ShamarrConnect Service"
            val channel = NotificationChannel(
                channelId,
                channelName, NotificationManager.IMPORTANCE_HIGH
            ).apply {
                description = "ShamarrConnect Service Channel"
            }
