...
def generate_control_file(version):
    ...
    content = """Package: shamarrconnect
Section: net
Priority: optional
Version: %s
Architecture: %s
Maintainer: ShamarrConnect <hello@shamarrconnect.com>
Homepage: https://shamarrconnect.com
...
def build_flutter_deb(version, features):
    ...
    system2('mkdir -p tmpdeb/usr/share/shamarrconnect')
    system2('mkdir -p tmpdeb/etc/shamarrconnect/')
    system2('mkdir -p tmpdeb/etc/pam.d/')
    system2('mkdir -p tmpdeb/usr/share/shamarrconnect/files/systemd/')
    system2('mkdir -p tmpdeb/usr/share/icons/hicolor/256x256/apps/')
    system2('mkdir -p tmpdeb/usr/share/icons/hicolor/scalable/apps/')
    system2('mkdir -p tmpdeb/usr/share/applications/')
    system2('mkdir -p tmpdeb/usr/share/polkit-1/actions')
    system2('rm tmpdeb/usr/bin/shamarrconnect || true')
    system2(
        f'cp -r {flutter_build_dir}/* tmpdeb/usr/share/shamarrconnect/')
    system2(
        'cp ../res/shamarrconnect.service tmpdeb/usr/share/shamarrconnect/files/systemd/')
    system2(
        'cp ../res/128x128@2x.png tmpdeb/usr/share/icons/hicolor/256x256/apps/shamarrconnect.png')
    system2(
        'cp ../res/scalable.svg tmpdeb/usr/share/icons/hicolor/scalable/apps/shamarrconnect.svg')
    system2(
        'cp ../res/shamarrconnect.desktop tmpdeb/usr/share/applications/shamarrconnect.desktop')
    system2(
        'cp ../res/shamarrconnect-link.desktop tmpdeb/usr/share/applications/shamarrconnect-link.desktop')
    system2(
        'cp ../res/startwm.sh tmpdeb/etc/shamarrconnect/')
    system2(
        'cp ../res/xorg.conf tmpdeb/etc/shamarrconnect/')
    system2(
        'cp ../res/pam.d/shamarrconnect.debian tmpdeb/etc/pam.d/shamarrconnect')
    system2(
        "echo \"#!/bin/sh\" >> tmpdeb/usr/share/shamarrconnect/files/polkit && chmod a+x tmpdeb/usr/share/shamarrconnect/files/polkit")

    system2('mkdir -p tmpdeb/DEBIAN')
    generate_control_file(version)
    system2('cp -a ../res/DEBIAN/* tmpdeb/DEBIAN/')
    md5_file_folder("tmpdeb/")
    system2('dpkg-deb -b tmpdeb shamarrconnect.deb;')

    system2('/bin/rm -rf tmpdeb/')
    system2('/bin/rm -rf ../res/DEBIAN/control')
    os.rename('shamarrconnect.deb', '../shamarrconnect-%s.deb' % version)
    os.chdir("..")
...
def build_deb_from_folder(version, binary_folder):
    ...
    system2('rm tmpdeb/usr/bin/shamarrconnect || true')
    system2(
        f'cp -r ../{binary_folder}/* tmpdeb/usr/share/shamarrconnect/')
    system2(
        'cp ../res/shamarrconnect.service tmpdeb/usr/share/shamarrconnect/files/systemd/')
    system2(
        'cp ../res/128x128@2x.png tmpdeb/usr/share/icons/hicolor/256x256/apps/shamarrconnect.png')
...
def build_flutter_dmg(version, features):
    ...
    system2('cp -rf ../target/release/service ./build/macos/Build/Products/Release/ShamarrConnect.app/Contents/MacOS/')
    '''
    system2(
