...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the ShamarrConnect network..."),
        ...
        ("install_tip", "Due to UAC, ShamarrConnect can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install ShamarrConnect to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant ShamarrConnect \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant ShamarrConnect \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow ShamarrConnect to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [ShamarrConnect Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next ShamarrConnect application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant ShamarrConnect \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant ShamarrConnect \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running ShamarrConnect."),
        ...
        ("verify_rustdesk_password_tip", "Verify ShamarrConnect password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use ShamarrConnect and start the service, do not proceed and hang up immediately."),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent ShamarrConnect from running properly as controlled side."),
        ...
        // Fork attribution (AGPL). Intentionally NOT rewritten by translate_locale
        // (powered_by_me is excluded from the RustDesk→APP_NAME replace).
        ("powered_by_me", "Powered by RustDesk"),
        ("About RustDesk", "About ShamarrConnect"),
        ("Show RustDesk", "Show ShamarrConnect"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if ShamarrConnect window is open"),
        ...
        ("floating_window_tip", "It helps to keep ShamarrConnect background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the ShamarrConnect client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, ShamarrConnect verifies the server certificate for protocols using TLS.\nWith this option enabled, ShamarrConnect will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, ShamarrConnect will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: The open-source relay does not include this feature."),
